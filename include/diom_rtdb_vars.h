 ...
 */
tU32S    diom_ti_us_cooldownPeriod_U32;      ///< [us]  [DIOM_TI_US_MIN_COOLDOWN_TIME]  [5000]  [DIOM_TI_US_MAX_COOLDOWN_TIME]   [Time in us for how long the signal has to settle before change to it can be registered again.]
tU32S    diom_ti_us_taskTime_U32;            ///< [us]  [DIOM_TI_US_MIN_TASK_TIME_U32]  [100]   [DIOM_TI_US_MAX_TASK_TIME_U32]   [Time in us between task execution]
