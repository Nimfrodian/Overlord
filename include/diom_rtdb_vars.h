 ...
 */
tU32S    diom_ti_us_cooldownPeriod_U32;      ///< [us]  [DIOM_TI_US_MIN_COOLDOWN_TIME_U32]  [DIOM_TI_US_DEF_COOLDOWN_TIME_U32]  [DIOM_TI_US_MAX_COOLDOWN_TIME_U32]   [Time in us for how long the signal has to settle before change to it can be registered again.]
tU32S    diom_ti_us_taskTime_U32;            ///< [us]  [DIOM_TI_US_MIN_TASK_TIME_U32]      [DIOM_TI_US_DEF_TASK_TIME_U32]      [DIOM_TI_US_MAX_TASK_TIME_U32]       [Time in us between task execution]
tU32S    diom_x_inputStates_U32;             ///< []    [0]                                 [0]                                 [0xFFFFFFFF]                         [States of the inputs as 32 bit mask]
