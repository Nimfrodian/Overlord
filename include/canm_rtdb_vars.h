 ...
 */
tBS    canm_s_rxRelayInvertReq_B   [128]; ///< []  [0]  [0]  [1]   [Relay invert requests]

tBS    canm_s_txGpioStates_B       [32];  ///< []  [0]  [0]  [1]   [State of GPIOs]
tBS    canm_s_txRelayStates_B      [128]; ///< []  [0]  [0]  [1]   [State of relays]
