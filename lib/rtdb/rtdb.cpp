...
tU32 rtdb_write_tU8S( tU8SEnumT VarName , tU8 NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tU8S[VarName], sizeof(tU8S)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tU16S( tU16SEnumT VarName , tU16 NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tU16S[VarName], sizeof(tU16S)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tU32S( tU32SEnumT VarName , tU32 NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tU32S[VarName], sizeof(tU32S)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tS8S( tS8SEnumT VarName , tS8 NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tS8S[VarName], sizeof(tS8S)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tS16S( tS16SEnumT VarName , tS16 NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tS16S[VarName], sizeof(tS16S)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tS32S( tS32SEnumT VarName , tS32 NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tS32S[VarName], sizeof(tS32S)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tES( tESEnumT VarName , tE NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tES[VarName], sizeof(tES)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tBS( tBSEnumT VarName , tB NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tBS[VarName], sizeof(tBS)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_write_tF32S( tF32SEnumT VarName , tF32 NewVal)
{
    ...
    // check CRC
    else if (rtdb_checkCrc32((void*) rtdb_arr_tF32S[VarName], sizeof(tF32S)))
    {
        // TODO
    }
    // check for MIN
...
tU32 rtdb_overwrite_tU8S( tU8SEnumT VarName , tU8 NewVal )
{
    ...
    tU8 valToWrite = rtdb_arr_tU8S[VarName]->tU8_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tU8S[VarName], sizeof(tU8S))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tU16S( tU16SEnumT VarName , tU16 NewVal )
{
    ...
    tU16 valToWrite = rtdb_arr_tU16S[VarName]->tU16_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tU16S[VarName], sizeof(tU16S))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tU32S( tU32SEnumT VarName , tU32 NewVal )
{
    ...
    tU32 valToWrite = rtdb_arr_tU32S[VarName]->tU32_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tU32S[VarName], sizeof(tU32S))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tS8S( tS8SEnumT VarName , tS8 NewVal )
{
    ...
    tS8 valToWrite = rtdb_arr_tS8S[VarName]->tS8_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tS8S[VarName], sizeof(tS8S))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tS16S( tS16SEnumT VarName , tS16 NewVal )
{
    ...
    tS16 valToWrite = rtdb_arr_tS16S[VarName]->tS16_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tS16S[VarName], sizeof(tS16S))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tS32S( tS32SEnumT VarName , tS32 NewVal )
{
    ...
    tS32 valToWrite = rtdb_arr_tS32S[VarName]->tS32_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tS32S[VarName], sizeof(tS32S))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tES( tESEnumT VarName , tE NewVal )
{
    ...
    tE valToWrite = rtdb_arr_tES[VarName]->tE_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tES[VarName], sizeof(tES))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tBS( tBSEnumT VarName , tB NewVal )
{
    ...
    tB valToWrite = rtdb_arr_tBS[VarName]->tB_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tBS[VarName], sizeof(tBS))) // TODO
    {
        // TODO
        stsCode = 1;
    }
...
tU32 rtdb_overwrite_tF32S( tF32SEnumT VarName , tF32 NewVal )
{
    ...
    tF32 valToWrite = rtdb_arr_tF32S[VarName]->tF32_val;
    // check CRC
    if (rtdb_checkCrc32( (void*) rtdb_arr_tF32S[VarName], sizeof(tF32S))) // TODO
    {
        // TODO
        stsCode = 1;
    }
