...
typedef enum
{
    DIOM_TI_COOLDOWNPERIOD_U32 = 0,               // Time in us for how long the signal has to settle before change to it can be registered again.
    DIOM_TI_INPUTSTATES_U32 = 1,                  // States of the inputs as 32 bit mask
    DIOM_TI_TASKTIME_U32 = 2,                     // Time in us between task execution
    ...
    MBCM_X_DESIREDRELAYSTATES_U32 = 5,            // Desired relay states as 32 bit mask
    NUM_OF_tU32S = 6
} tU32SEnumT;
